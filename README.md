...
| `uuid` | ✅ | シーン識別子（ファイル名に使用） |
| `timestamp` | ✅ | 対象タイムスタンプ（マイクロ秒、Unix時刻） |
...
入力例 (`scenes.csv`):
```csv
t4dataset_id,uuid,timestamp,status,cameras,description
dataset-abc,scene-001,1609459200000000,degrade,,
dataset-abc,scene-002,1609459300000000,improved,CAM_FRONT,fix applied
dataset-def,scene-003,1609459400000000,,,
```
...
├── degrade/
│   ├── dataset-abc_scene-001_1609459200000000_cameras.png
│   ├── dataset-abc_scene-001_1609459200000000_pointcloud.png
│   └── dataset-abc_scene-001_1609459200000000_meta.txt
└── improved/
    ├── dataset-abc_scene-002_1609459300000000_cameras.png
    └── ...
```
